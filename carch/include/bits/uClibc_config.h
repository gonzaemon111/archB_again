...
#define __KERNEL_HEADERS__ "/root/buildroot/toolchain_build_mipsel/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/usr/local/bin//usr/bin/mipsel-linux-uclibc-"
